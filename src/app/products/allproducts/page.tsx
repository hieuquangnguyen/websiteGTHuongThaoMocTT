        ...
        <LayoutProductPage>
          ...
          <LayoutProductList>
            ...
            <ProductItem
              ...
              title="Hương Nụ"
              price="LIÊN HỆ"
              huonglieu="là sự kết hợp của các nguyên liệu từ tự nhiên như rễ găng núi, rễ hương lâu, rễ quýt rừng, keo bời lời, cùng một số thảo dược khác. "
              muithom="hương găng núi thường có mùi hương đậm, nguyên thủy và mạnh mẽ. Hương găng núi thường được ưa chuộng vì tính tinh khiết và khả năng tạo ra mùi hương mạnh mẽ và lâu dài. Tạo cho con người cảm giác dễ chịu, sảng khoái nhất. "
              kichthuoc="Nụ cao 4.3 cm, cháy trong 20p"
              theloai="Nhang nụ, có lỗ nhỏ dưới đáy nụ để cắm chu tăm. Thích hợp để trên những chân thắp nụ, tỏa khói đẹp."
              priceSi="LIÊN HỆ"
              priceLe="LIÊN HỆ"
